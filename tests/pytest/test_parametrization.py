...
class TestOperations:
    ...
    def test_user_without_operations(self, user: str):
        print(f'User without operations: {user}s')


users = {
    "+70000000000011": "User with money on bank account",
    "+70000000000022": "User without money on bank account",
    "+70000000000033": "User with operations on bank account"
}
